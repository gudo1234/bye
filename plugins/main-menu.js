...
if (command == 'menu' || command == 'menú' || command == 'help' || command == 'ayuda' || command == 'comandos' || command == 'memu') {
...
if (command == 'menuinfobot' || command == 'menu1') {
conn.reply(m.chat, tes, m, rcanal)
};

if (command == 'menubuscadores' || command == 'menu2') {
conn.reply(m.chat, tes2, m, rcanal)
};

if (command == 'menudescargas' || command == 'menu3') {
conn.reply(m.chat, tes3, m, rcanal)
};

if (command == 'menueconomia' || command == 'menu4') {
conn.reply(m.chat, tes4, m, rcanal)
};

if (command == 'menugacha' || command == 'menu5') {
conn.reply(m.chat, tes5, m, rcanal)
};

if (command == 'menustickers' || command == 'menu6' || command == 'menusticker' || command == 'menustiker') {
conn.reply(m.chat, tes6, m, rcanal)
};

if (command == 'menuherramientas' || command == 'menu7') {
conn.reply(m.chat, tes7, m, rcanal)
};

if (command == 'menuperfil' || command == 'menu8') {
conn.reply(m.chat, tes8, m, rcanal)
};

if (command == 'menugrupos' || command == 'menu9') {
conn.reply(m.chat, tes9, m, rcanal)
};

if (command == 'menuanime' || command == 'menu10') {
conn.reply(m.chat, tes10, m, rcanal)
};

if (command == 'menunsfw' || command == 'menu11') {
conn.reply(m.chat, tes11, m, rcanal)
};

};
handler.help = ['menu'];
handler.tags = ['main'];
handler.command = ['menu', 'menú', 'help', 'ayuda', 'comandos', 'memu', 'menuinfobot', 'menu1', 'menubuscadores', 'menu2', 'menudescargas', 'menu3', 'menueconomia', 'menu4', 'menugacha', 'menu5', 'menustickers', 'menu6', 'menuherramientas', 'menu7', 'menuperfil', 'menu8', 'menugrupos', 'menu9', 'menuanime', 'menu10', 'menunsfw', 'menu11'];
handler.group = true
