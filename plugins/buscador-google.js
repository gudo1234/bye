...
let handler = async (m, { text }) => {
  if (!text) {
    m.reply(`${e} Por favor, proporciona el termino de búsqueda que deseas realizar a *Google*.`);
    return;
  }
  ...
  try {
    ...
    let replyMessage = `${e} Resultados de la búsqueda:\n\n`;
...
m.react('✅')
    ...
    m.reply(`${e} Ocurrió un error al obtener los resultados.`);
  }
};
