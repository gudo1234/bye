...
let handler = async (_0x10bd40, {
  ...
  if (!_0x27db11) {
    return _0x9c7141.reply(_0x10bd40.chat, `${e} Por favor, ingresa lo que deseas buscar en pinterest.`, _0x10bd40, rcanal);
  }
    await _0x10bd40.react(rwait);
 _0x9c7141.reply(_0x10bd40.chat, `${e} Descargando su imagen, espere un momento...`, _0x10bd40, {
