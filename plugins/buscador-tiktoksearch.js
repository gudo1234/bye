...
if (!text) return conn.reply(message.chat, ,`${e} Por favor, ingrese lo que desea buscar en tiktok.`, message, rcanal)
...
conn.reply(message.chat, `${e} Descargando Su Video, espere un momento...`, message, {
