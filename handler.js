...
m.reply(`${e} Estas baneado/a, no puedes usar comandos en este bot!\n\n${user.bannedReason ? `\n📝 *Motivo:* 
${user.bannedReason}` : '📄 *Motivo:* Sin Especificar'}\n\n🍧 Si quieres que seas desbaneado en este bot escribe a: Wa.me/50492280729`)
user.antispam++        
return
}
...
conn.reply(m.chat, `${e} Se agotaron tus ${global.moneda}`, m)
continue
}
let extra = {
match,
